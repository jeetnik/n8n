...
import { AnimatedBeamDemo } from "./ui/Animate";
...
>(({ className, children }, ref) => {
    return (
        <div
            ref={ref}
            className={cn(
                "z-10 flex size-12 items-center justify-center rounded-full border border-white/10 bg-black p-3 shadow-[0_0_20px_-12px_rgba(255,255,255,0.2)]",
                className
            )}
        >
            {children}
                ...
                <div className="relative grid md:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <p className="text-lg text-gray-400 mb-8 leading-relaxed">
                            Whether you're processing 10 events or 10 million, n8n scales
                            with you. Our event-driven architecture ensures zero-latency
                            handling for your most critical workflows.
                        </p>
                    ...
                    {/* Animated Beam Demo Visualization */}
                    <div
                        className="relative flex h-[400px] w-full items-center justify-center overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-6"
                        ref={containerRef}
                    >
                        <AnimatedBeamDemo />
                    </div>
